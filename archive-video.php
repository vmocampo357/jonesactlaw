...
<div class="innerpage_tile">
  <div class="cont"><h3>Video</h3></div>
</div>
...
<h4>Get Answers Instantly By Watching Our Videos</h4>
<p>Check out our Maritime Video Library, which features videos covering critical topics related to maritime personal injuries and protecting your future after an injury.</p>
...
<div class="section">
<div class="sort_head">SORT VIDEOS BY CLAIM TYPE</div>
<div id="tabnav">
<ul class="nav">
<li class="col-2" id="tab1_link"><a href="javascript:void(0)">WATCH THESE FIRST</a></li>
...
<li class="col-2" id="tab6_link"><a href="javascript:void(0)">Other Helpful Videos</a></li>
</ul>
<div class="clear"></div>
</div>
<div id="tab_content">
...
<?php
echo do_shortcode('[ajax_load_more post_type="video" posts_per_page="9" max_pages="0" button_label="View More Videos" scroll="false"]');
?>
</div>
<div id="tab1_content">
<?php
	echo do_shortcode('[ajax_load_more post_type="video" posts_per_page="9" max_pages="0" category="watch-these-first" button_label="View More Videos" scroll="false"]');
?>
</div>
<div id="tab2_content">
<?php
	echo do_shortcode('[ajax_load_more post_type="video" posts_per_page="9" max_pages="0" category="getting-medical-treatment" button_label="View More Videos" scroll="false"]');
?>
</div>
<div id="tab3_content">
<?php
	echo do_shortcode('[ajax_load_more post_type="video" posts_per_page="9" max_pages="0" category="paying-your-bills" button_label="View More Videos" scroll="false"]');
?>
</div>
<div id="tab4_content">
<?php
	echo do_shortcode('[ajax_load_more post_type="video" posts_per_page="9" max_pages="0" category="returning-to-work" button_label="View More Videos" scroll="false"]');
?>
</div>
<div id="tab5_content">
<?php
	echo do_shortcode('[ajax_load_more post_type="video" posts_per_page="9" max_pages="0" category="understanding-your-claim" button_label="View More Videos" scroll="false"]');
?>
</div>
<div id="tab6_content">
<?php
	echo do_shortcode('[ajax_load_more post_type="video" posts_per_page="9" max_pages="0" category="other-helpful-videos" button_label="View More Videos" scroll="false"]');
?>
</div>
<div class="clear"></div>
</div>
