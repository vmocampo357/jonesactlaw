...
<script type="text/javascript">
	$(window).load(function() {
		...
		$('#header_menu_cont2 .icon').click(function (e) {
		
			$('#header_menu_cont3').fadeToggle(300);
...
<div id="download_book_now" class="overlay_book">
    <div class="popup_book">
        ...
        function formGenerate(btn_num){
            if (btn_num	==	1) {
            var pop_body_home	=	'<form accept-charset="UTF-8" action="https://tschedule.infusionsoft.com/app/form/process/353fcdaa19e275ec3a2f0a23eeac6858" class="infusion-form" method="POST"><input name="inf_form_xid" type="hidden" value="353fcdaa19e275ec3a2f0a23eeac6858" /><input name="inf_form_name" type="hidden" value="Homepage UYOI Form" /><input name="infusionsoft_version" type="hidden" value="1.51.0.56" /><div class="infusion-field"><label for="inf_field_FirstName">First Name *</label><input class="infusion-field-input-container" id="inf_field_FirstName" name="inf_field_FirstName" type="text" /></div><div class="infusion-field"><label for="inf_field_Email">Email *</label><input class="infusion-field-input-container" id="inf_field_Email" name="inf_field_Email" type="text" /></div><div class="infusion-submit"><input type="submit" value="Download Now" /></div></form>'; }
            if (btn_num == 2) {
                var pop_body_home	= '<form accept-charset="UTF-8" action="https://tschedule.infusionsoft.com/app/form/process/3dbed3ec948bedb36f0e0872e4ea6dbb" class="infusion-form" method="POST"><input name="inf_form_xid" type="hidden" value="3dbed3ec948bedb36f0e0872e4ea6dbb" /><input name="inf_form_name" type="hidden" value="Homepage FTT Form" /><input name="infusionsoft_version" type="hidden" value="1.51.0.56" /><div class="infusion-field"><label for="inf_field_FirstName">First Name *</label><input class="infusion-field-input-container" id="inf_field_FirstName" name="inf_field_FirstName" type="text" /></div><div class="infusion-field"><label for="inf_field_Email">Email *</label><input class="infusion-field-input-container" id="inf_field_Email" name="inf_field_Email" type="text" /></div><div class="infusion-submit"><input type="submit" value="Download Now" /></div></form>'; }
                $('#form_append_new').html(pop_body_home);
        }
                </script>
        </div>
    </div>
