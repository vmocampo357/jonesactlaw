...
<?php if ($points[0] <= 20) { ?>
	<p>Some of the answers you gave indicate that you will face multiple challenges in pursuing your claim.  This does not necessarily mean you don’t have a valuable claim.  All it means is that you can expect the company to throw the usual defenses at you while you move forward trying to collect a fair settlement.</p>
<?php } ?>
<?php if ($points[0] > 20 && $points[0] <= 30) { ?>
	<p>Moving forward with your claim will likely be a smart move on your part.  While the company may try to challenge some of your claim, other parts are probably well in your favor.  You probably have a lot of money at stake, so be careful moving forward to handle everything properly. </p>
<?php } ?>
<?php if ($points[0] > 30) { ?>
	<p>You want to be very careful moving forward.  Your future has probably been very affected by your injury and you may have the basis of a very valuable claim.  A lot is at stake for you, and there are definitely right and wrong ways to handle things to make your future better.   Speak to an attorney as soon as you can.</p>
<?php } ?>
