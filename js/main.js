...
jQuery(function ($) {
  ...
  var
    is_menu_mobile = function () {
      return $('#header_menu_cont .icon').is(':visible');
    },
...
//console.log({wt: wt, have: $injury.length, fit: injury_fit, w1: w1});
  ...
  //mobile header menu
  $('#header_menu_cont .icon').click(function (e) {
    e.preventDefault();
    $('#header_menu_cont3').fadeToggle(300);
  });
  //header menu hover & click
  $('#header_menu li.sub').hover(function (e) {
  ...
  //header menu clicked
  $('#header_menu li.sub > a').click(function (e) {
    e.preventDefault();
    var
      $li = $(this).parent(),
  ...
  //header search
  $('#header_menu .search').click(function (e) {
    e.preventDefault();
    $('#header_menu .search_form').fadeToggle();
  });
  //header search submit
  $('#header_menu .search_form').submit(function (e) {
    //cancel if empty
